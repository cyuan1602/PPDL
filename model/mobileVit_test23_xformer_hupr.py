...
class GatelessCoherentFusion(nn.Module):
    ...
    def forward(self, spatial_feat, temporal_feat):
        ...
        constructive = spatial_feat + temporal_feat
        destructive = spatial_feat - temporal_feat
        ...
        fused = constructive + interacted - 0.1 * (destructive * energy_bias)
        
        return self.norm(self.evolution(fused) + spatial_feat)
